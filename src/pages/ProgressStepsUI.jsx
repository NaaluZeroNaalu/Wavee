...
const ProgressStepUI = () => {
  ...
  const steps = [
    { id: 1, title: 'Choose Open Date', icon: 'calendar-plus', field: 'openDate' },
    { id: 2, title: 'Choose Close Date', icon: 'calendar-minus', field: 'closeDate' },
    { id: 3, title: 'Choose End Date', icon: 'calendar-check', field: 'endDate' },
    { id: 4, title: 'Finish', icon: 'check-circle', field: null }
  ];
  ...
  const isStepValid = (step) => {
    switch (step) {
      case 1: return formData.openDate !== '';
      case 2: return formData.closeDate !== '';
      case 3: return formData.endDate !== '';
      case 4: return true;
      ...
      case 4:
        return (
          <div className="text-center">
            ...
            <p className="text-muted mb-4">Your date configuration has been successfully set up</p>
              ...
              <div className="card-body p-4">
                <div className="row">
                  {steps.map((step, index) => {
                    ...
                    return (
                      <div key={step.id} className="col-md-3 text-center">
